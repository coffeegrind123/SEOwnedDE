...
// Amalgam CPredictionCopy constants - 1:1 port
...
// Amalgam CPredictionCopy class - exact 1:1 port
...
public:
	...
	// Exact Amalgam TransferData method - will use signature call
...
// CPredictionCopy signature for Amalgam-style calling
